...
function toggleParentPageOverflow(disable) {
    ...
    if (disable) {
        state.overflow.originalBodyOverflow = document.body.style.overflow;
        state.overflow.originalDocumentOverflow = document.documentElement.style.overflow;
        document.body.style.overflow = 'hidden';
        document.documentElement.style.overflow = 'hidden';
    } else {
        document.body.style.overflow = state.overflow.originalBodyOverflow;
        document.documentElement.style.overflow = state.overflow.originalDocumentOverflow;
    }
